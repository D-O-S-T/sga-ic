...
@Component({
  ...
  templateUrl: './atividade-respostas-prof.component.html',
  styleUrl: './atividade-respostas-prof.component.scss'
})
export class AtividadeRespostasProfComponent implements OnInit {
