...
import br.edu.undf.sga_ic.service.RespostaService;
...
@Tag(name = "RespostaController", description = "Endpoints relacionados a requisições de Respostas de Atividade")
public class RespostaController {
	...
	public ResponseEntity<Retorno> registrar(@RequestParam String descricao, @RequestParam Long atividadeId,
		...
		return respostaService.registrar(descricao, atividadeId, arquivos, request);
	}
}